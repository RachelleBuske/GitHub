...
RMi=0.01    %mitral valve resistance (mmHg/(liter/minute)) [increase to model stenosis]
RAo=0.01     %aortic valve resistance (mmHg/(liter/minute)) [increase to model stenosis]
