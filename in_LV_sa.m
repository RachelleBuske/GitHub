...
% Overview: initialization program for simulating the left heart and the systemic arteries
T =0.0125/1    %Duration of heartbeat (minutes)
TS=0.0050/1    %Duration of systole   (minutes)
tauS=0.0025  %CLV time constant during systole (minutes)
tauD=0.0075  %CLV time constant during diastole (minutes)
Rs=17.86/1     %Systemic resistance (mmHg/(liter/minute)) 
...
klokmax=(15*T/dt)*1 %Total number of timesteps 
